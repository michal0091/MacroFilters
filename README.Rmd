...
[![CRAN status](https://www.r-pkg.org/badges/version/MacroFilters)](https://CRAN.R-project.org/package=MacroFilters)
[![DOI](https://zenodo.org/badge/DOI/10.32614/CRAN.package.MacroFilters.svg)](https://doi.org/10.32614/CRAN.package.MacroFilters)
<!-- badges: end -->

> **Working Paper Available:** The econometric methodology and mathematical proofs underlying this package are distributed via SSRN: [Robust Real-Time Macroeconomic Trend Extraction: A Gradient Boosting Approach](https://doi.org/10.2139/ssrn.6371138).
...
See `vignette("introduction", package = "MacroFilters")` for a full walkthrough covering all four filters and the S3 print/meta interface.
